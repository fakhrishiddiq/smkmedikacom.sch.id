...
<head>
    ...
    <title>SMK Medikacom Bandung - Selamat Datang di SMK Medikacom Bandung</title>
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>022-7314090 - 7309811
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@medikacom.sch.id
                        </div>
                        <div class="header-top_list">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website SMK Medikam Bandung yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Jl.Rancabolang, Manjahlega, Jawa Barat 40286</p>
                        <p>Email : info@medikacom.sch.id
                            <br> Phone : 022-7314090 - 7309811, Fax : 022-7314088</p>
